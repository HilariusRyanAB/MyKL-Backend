...
class SendNotification2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'create:sendNotification2';
     ...
     * @var string
     */
    protected $description = 'Send Notification2 automatically';
            ...
            for($count = 0; $count < count($users); $count++)
            {
                ...
                {                
                    $unpaidBilling = DB::table('properti')
                        ...
                        ->where('billing.status_billing', '=', 'Overdue')
                    ...
                    if(!is_null($unpaidBilling))
                    {
                        ...
                        $message = CloudMessage::fromArray([
                            ...
                            'notification' => [
                                ...
                                'body' => 'Please Pay Your Bill as Soon as Possible before All of Your Facility Been Locked'
                            ]
                        ]);
