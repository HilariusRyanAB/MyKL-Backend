...
class SendBillingOwner extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:billingO';
     ...
     * @var string
     */
    protected $description = 'Command to Send Billing for Owner';
    ...
    public function handle()
    {
        ...
        for($count = 0; $count < count($billings); $count++)
        {
            ...
            if(strlen($billing->nomor_telepon_pemilik) < 11)
            {
            ...
            else
            {
                ...
                $recipient = "whatsapp:+62".substr($billing->nomor_telepon_pemilik, 1);
                ...
                //Email
                $dataEmail["email"] = $billing->email_pemilik;
