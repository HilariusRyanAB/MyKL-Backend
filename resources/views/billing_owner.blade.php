...
<html lang="en">
    <head>
        ...
        <title>Billing-{{$billing->nomor_billing}}-O</title>
    </head>
        ...
        <div id="BillingOwner" style="width: 500px; border: 2px black solid; overflow-y: hidden;">
            ...
            <div>
                <table id="tabelTitle" class="black--text" style="table-layout:fixed; width: 470px; margin-left: 25px; border-collapse: collapse;">
                    <thead style="border-top: 2.4px black dashed; margin-top: 5px">
                        <tr>
                            <th class="text-left" style="font-size: 12px; width: 265px">Pemilik: {{$billing->nama_pemilik}}</th>
            ...
            <div style="margin-bottom: 5px; margin-top: 2px">
                <table id="tabelTitle" class="black--text" style="table-layout:fixed; width: 470px; margin-left: 25px; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th class="text-left" style="font-size: 12px; width: 265px">Alamat: {{$billing->alamat_pemilik}}</th>
            ...
            <div>
                <table id="tabelSubtitle" class="black--text" style="table-layout:fixed; width: 470px; margin-left: 25px; border-collapse: collapse;">
                    <thead style="border-top: 2.4px black dashed;">
                        <tr>
                            <th class="text-left" style="font-size: 12px;">Cetakan ke - 1</th>
